...
export default function WritingTestsPage() {
  ...
  const { data: tests = [], isLoading, error } = useGetWritingTestsQuery();
    ...
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Practice with our collection of IELTS writing tests. Choose between academic and general training tests.
        </p>
      </div>
          ...
          <Card key={test._id} className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <Button asChild className="w-full">
                <Link to={`/tests/writing/${test._id}`}>
